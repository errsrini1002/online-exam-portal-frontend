...
const MyAttendanceView = () => {
    ...
    const fetchAttendanceByStudentId = async () => {
        try {
            const response = await fetch(url + `/attendance/student/${student.id}`);
            if (response.ok) {
    ...
    return (
        <div>
            ...
            <div>
                    <h4 style={{ color: 'brown' }}>ATTENDANCE REPORT </h4>
            ...
            <div>
                <button onClick={fetchAttendanceByStudentId}>Submit</button>
            </div>
            <div>
                <div>
                    <h5 style={{ color: 'blue' }}>Student ID: {student.id}</h5>
                    <h5 style={{ color: 'blue' }}>Student Name: {student.firstName}</h5>
                    <h5 style={{ color: 'blue' }}>Year/Class: {student.grade.name}</h5>
                </div>
